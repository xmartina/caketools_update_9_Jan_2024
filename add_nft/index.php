...
if (isset($_POST['create_new_nft'])) {
    ...
    if ($uploadedFile['error'] === UPLOAD_ERR_OK) {
        ...
        if (move_uploaded_file($tempFilePath, $targetPath)) {
            ...
            $insertNftParentSql = "INSERT INTO nft_parent (ref_id, created_user_id, current_owner_id, service_fee, is_hot_pick, hot_pick_category, category_id, name, description, available_quantity, nft_img, price_currency, nft_price) VALUES ('$ref_id','$user_id','$user_id','0.0025','1','$hot_pick_category','$category_id', '$name', '$description', '$available_quantity', '$filename', '$nft_currency', '$nft_price')";
