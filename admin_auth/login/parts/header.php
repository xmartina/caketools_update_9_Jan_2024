...
<head>
    ...
    <!-- Vendor -->
    <link rel="stylesheet" href="<?=adminUrl?>assets/vendor/libs/@form-validation/umd/styles/index.min.css" />

    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="<?=adminUrl?>assets/vendor/css/pages/page-auth.css" />
